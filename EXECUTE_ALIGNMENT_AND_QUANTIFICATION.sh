...
do
	...
	check_strandedness --gtf /home/vera/Desktop/UBUNTU_LAB/DATA/RNA-SEQ/INDEX/MOUSE/STAR/Genome_Mus_musculus_GrcM38_102/Mus_musculus.GRCm38.102.gtf --transcripts /home/vera/Desktop/UBUNTU_LAB/DATA/RNA-SEQ/INDEX/MOUSE/STAR/Genome_Mus_musculus_GrcM38_102/Mus_musculus.GRCm38.cdna.all.fa --reads_1 ./SAMPLES/NO_FILTERED/"$Sample"/"$Sample"_1.fq.gz --reads_2 ./SAMPLES/NO_FILTERED/"$Sample"/"$Sample"_2.fq.gz > ./STRAND/"$Sample".txt
...
# Star_index GRCm39 --> /home/vera/Desktop/UBUNTU_LAB/DATA/INDEX/MOUSE/STAR/Genome_Mus_musculus_GrcM39_104/GRCm39_STAR_index

# GTF GRCm39 --> /home/vera/Desktop/UBUNTU_LAB/DATA/INDEX/MOUSE/STAR/Genome_Mus_musculus_GrcM39_104/Mus_musculus.GRCm39.104.gtf
...
do
	...
	STAR --runMode alignReads --runThreadN 6 --readFilesCommand zcat --genomeDir /home/vera/Desktop/UBUNTU_LAB/DATA/RNA-SEQ/INDEX/MOUSE/STAR/Genome_Mus_musculus_GrcM39_104/GRCm39_STAR_index --sjdbGTFfile /home/vera/Desktop/UBUNTU_LAB/DATA/RNA-SEQ/INDEX/MOUSE/STAR/Genome_Mus_musculus_GrcM39_104/Mus_musculus.GRCm39.104.gtf --outSAMtype BAM SortedByCoordinate --outFileNamePrefix ./RESULTS_STAR/FILTERED_NOVOGENE/"$Sample"/"$Sample"_ --readFilesIn ./SAMPLES/FILTERED_NOVOGENE/"$Sample"/"$Sample"_1.clean.fq.gz ./SAMPLES/FILTERED_NOVOGENE/"$Sample"/"$Sample"_2.clean.fq.gz
...
do
	...
	htseq-count -a 10 -m intersection-nonempty -i gene_id -f bam -s no -r pos ./RESULTS_STAR/FILTERED_NOVOGENE/"$Sample"/"$Sample"_Aligned.sortedByCoord.out.bam /home/vera/Desktop/UBUNTU_LAB/DATA/RNA-SEQ/INDEX/MOUSE/STAR/Genome_Mus_musculus_GrcM39_104/Mus_musculus.GRCm39.104.gtf > ./RESULTS_HTSEQ/FILTERED_NOVOGENE/"$Sample"/"$Sample"_htseq.txt

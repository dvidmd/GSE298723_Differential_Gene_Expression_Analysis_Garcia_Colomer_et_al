---
title: "KO_NT_vs_KO_R24_CONTROL_VS_TREATMENT"
...
library(apeglm)
condition_KO_R24_vs_KO_NT <- lfcShrink(dds, coef="condition_KO_R24_vs_KO_NT", type="apeglm")
...
filterValues <- rownames(condition_KO_R24_vs_KO_NT)
...
colnames(annot)
colnames(condition_KO_R24_vs_KO_NT)

annot_final <- as.data.frame(condition_KO_R24_vs_KO_NT) %>% 
...
# Write tables:
write.table(annot_final,file = "condition_KO_R24_vs_KO_NT.xls", sep = "\t")

---
title: "PCA_CODE_WT_NT_KO_NT_AND_KO_R24"
...
expr_mat <- read.delim(
  "WT_NT_KO_NT_AND_KO_R24_VST.txt",
  header = TRUE,
  sep    = "\t",
...
##################################################
# 2. Read metadata and keep WT_NT, KO_NT, KO_R24 #
##################################################
...
metadata_use <- metadata |>
  filter(Group %in% c("WT_NT", "KO_NT", "KO_R24")) |>
  select(Group)                |>
  `names<-`("Condition")
...
metadata_use$Condition[metadata_use$Condition == "KO_R24"]  <- "KO + Rapamycin"

# Desired order in the legend:

metadata_use$Condition <- factor(
  metadata_use$Condition,
  levels = c("WT", "KO", "KO + Rapamycin")
)
...
ggsave("PCA_DEG_FROM_FDR_0_05_FC_1_5_WT_NT_VS_KO_NT_IN_WT_NT_AND_KO_NT_AND_KO_P_RAPAMYCIN_VST.png",
       plot   = fig_plain,
       dpi    = 1200,
       width  = 8, height = 8, units = "in")

ggsave("PCA_DEG_FROM_FDR_0_05_FC_1_5_WT_NT_VS_KO_NT_IN_WT_NT_AND_KO_NT_AND_KO_P_RAPAMYCIN_VST_WITH_LABELS.png",
       plot   = fig_labels,
       dpi    = 1200,
       width  = 8, height = 8, units = "in")
...
ggsave("PCA_DEG_FROM_FDR_0_05_FC_1_5_WT_NT_VS_KO_NT_IN_WT_NT_AND_KO_NT_AND_KO_P_RAPAMYCIN_VST.svg",
       plot   = fig_plain,
       device = "svg",
       width  = 8, height = 8, units = "in")

ggsave("PCA_DEG_FROM_FDR_0_05_FC_1_5_WT_NT_VS_KO_NT_IN_WT_NT_AND_KO_NT_AND_KO_P_RAPAMYCIN_VST_WITH_LABELS.svg",
       plot   = fig_labels,
       device = "svg",
       width  = 8, height = 8, units = "in")
